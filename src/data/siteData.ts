...
export const letterBody: string[] = [
  "สวัสดีนะหญิง 💕",
  "ตั้งแต่วันแรกที่พี่ได้เจอเรา พี่ก็รู้สึกว่าเราเป็นคนพิเศษ ยิ้มของเราทำให้พี่มีความสุขได้ทุกครั้งที่เห็น",
  "ขอบคุณที่อยู่เคียงข้างพี่มาตลอด 3 เดือนนี้นะ ขอบคุณที่เป็นกำลังใจให้พี่เสมอ ขอบคุณที่ทำให้พี่ยิ้มได้กว้างขึ้นในทุกๆวัน",
  "พี่โชคดีมากๆเลยจริงๆ ที่ในปีนี้ พี่ได้มาเจอเรา ได้รู้จักเรา และได้ใช้เวลาดีๆด้วยกัน",
  "ขอบคุณสำหรับความทรงจำที่ดีตลอดมานะ ไม่ว่าจะเป็นทริปแรกของเรา รูปวาดเป็ดสองตัวในทุ่งดอกไม้ หรือเวลาที่อยู่ด้วยกันแค่ 2 คน พี่มีความสุขทุกครั้งเลย",
  "เรามาเลื่อนดูความทรงจำด้วยกันต่อข้างล่างนะ ↓",
];

// ── Thai Ending Line ────────────────────────────────────────────
export const letterEndingThai =
  "เรามาสร้างความทรงจำด้วยกันต่อจากนี้ให้เยอะขึ้นๆไปอีกนะะ";
